void check_puasa()
  {
    ...
    if (  ((tmrH.hM == 12)  and   (tmrH.hD == 10)) or   // Idul Adha
          ...
          ((tmrH.hM ==  8)  and   (tmrH.hD == 16)) or  // Akhir bulan Sya'ban
          ((tmrH.hM ==  8)  and   (tmrH.hD == 17)) or  
          ((tmrH.hM ==  8)  and   (tmrH.hD == 18)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 19)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 20)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 21)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 22)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 23)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 24)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 25)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 26)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 27)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 28)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 29)) or 
          ((tmrH.hM ==  8)  and   (tmrH.hD == 30)))   // Akhir bulan Sya'ban
        {
          ty_puasa = 0;
        }
    else 
