...
void loop()
  { 
   ...
   // dwMrq(drawInfo(430)   ,90,1,10);                            // addr: 10 show Info 3
    ...
    dwMrq(drawInfo(580),75,0,102); //Message Sholat biasa       // addr: 202 show Message Sholah
    dwMrq(drawInfo(730),75,0,103); //Message Sholat jumat       // addr: 203 show Message Jum'at
    blinkBlock(104);                                            // addr: 104 show Blink  Sholat    

    // =========================================
    // Display Control Block ===================
    // =========================================
    if(RunFinish==1) {RunSel = 3; RunFinish =0;}                      //after anim 1 set anim 2
   // if(RunFinish==2) {RunSel = 3; RunFinish =0;}                      //after anim 2 set anim 3
    ...
    if(RunFinish==9) {RunSel = 1;  RunFinish =0;}                      //after anim 10 set anim 1
